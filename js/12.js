...
//! в этом коде акзизный сбор считается по формуле = цена авто в инпуте * коеф бензин 3,1%
...
(function () {
  ...
  function updateCoefficient() {
    if (selectedFuel) {
      ...
      exciseDutyValue = Math.round(coefficient * sumaAvto); // ! вот тут расчет акциза 10000*0,031
