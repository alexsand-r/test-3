"use strict";
/*
Этот код динамически обновляет список городов и стоимость доставки в зависимости от выбранной страны и города.
 При выборе страны из выпадающего списка отображается соответствующий список городов. Затем, при выборе конкретного города, обновляется цена доставки, которая отображается на странице.
